...
with open('resultsS02.pkl', 'wb') as f:
	pickle.dump(results, f)

with open('resMapS02.pkl', 'wb') as g:
	pickle.dump(resMap, g)

with open('resCoeffS02.pkl', 'wb') as h:
	pickle.dump(resCoeff, h)

with open('grwthRatesS02.pkl', 'wb') as h:
